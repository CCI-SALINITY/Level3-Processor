...
output_dir=('/net/nfs/tmp15/chakroun/L3_output/Level3_intermediate/SSS_AQUARIUS_merged/monthly/');
...
for ii=1:length(ndate)%tous les mois possibles entre t0 et tend
	...
	if (cmpt>0)
		...
		output_file=([output_dir,'aquariusL3_monthlyaveraged_',Datecentral,'centred']);
