...
output_dir=('/net/nfs/tmp15/chakroun/L3_output/Level3_intermediate/SSS_SMOS_merged/weekly/');
...
for ii=1:njours%toutes les semaines possibles entre t0 et end
	...
	if (cmpt>0)
		...
		sigma=sqrt(SSS_smos_random.^2+hebdo.^2+sss_erreur_L4.^2);
		...
		save(output_file,'SSS_smos','SSS_smos_bias','SSS_smos_random','nobs_smos','sss_qc_smos','noutliers_L4_smos') 
		netcdf.close(nc)
	end
end
