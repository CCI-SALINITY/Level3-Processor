...
input_dir_smos='/net/nfs/tmp15/chakroun/L3_output/Level3_intermediate/SSS_SMOS_merged/monthly/';%input directory
dirL3_smos=dir(input_dir_smos);
input_dir_smap='/net/nfs/tmp15/chakroun/L3_output/Level3_intermediate/SSS_SMAP_merged/monthly/';%input directory
dirL3_smap=dir(input_dir_smap);
input_dir_aquarius='/net/nfs/tmp15/chakroun/L3_output/Level3_intermediate/SSS_AQUARIUS_merged/monthly/';%input directory
dirL3_aquarius=dir(input_dir_aquarius);

%chemin output

output_dir='/net/nfs/tmp15/chakroun/L3_output/L3C_nc/monthly/';%output directory
...
for kk=2:length(ndate)
	...
	input_smos_file=([input_dir_smos,'smosL3_monthlyaveraged_',date_file,'centred.mat']);
	input_smap_file=([input_dir_smap,'smapL3_monthlyaveraged_',date_file,'centred.mat']);
	input_aquarius_file=([input_dir_aquarius,'aquariusL3_monthlyaveraged_',date_file,'centred.mat']);
	...
	L3P_ncfile=([output_dir,'ESACCI-SEASURFACESALINITY-L3C-SSS-SMOSSMAPAQUARIUS_Monthly_Centred_15Day_25km-',date_file,'-fv',fileversion,'.nc']) %output file
